...
public class ReduceNewsStatistic implements ReduceFunction<Tuple2<String, NewsStatistic>> {

	private static final long serialVersionUID = -3774580297290424421L;

	@Override
	public Tuple2<String, NewsStatistic> call(Tuple2<String, NewsStatistic> v1, Tuple2<String, NewsStatistic> v2)
			throws Exception {
		...
		return new Tuple2<String, NewsStatistic>(v1._1, new NewsStatistic(newMap, combinedTotal));
	}
